...
class SenMLFloatActuator : public SenMLFloatRecord {
 public:
  SenMLFloatActuator(const char *name, FLOAT_ACTUATOR_SIGNATURE) : SenMLFloatRecord(name, SENML_UNIT_NONE, 0.0),
                                                                   callback(callback) {};

  SenMLFloatActuator(const char *name, SenMLUnit unit, FLOAT_ACTUATOR_SIGNATURE) : SenMLFloatRecord(name, unit, 0.0),
                                                                                   callback(callback) {};

  SenMLFloatActuator(const char *name, SenMLUnit unit, float value, FLOAT_ACTUATOR_SIGNATURE) : SenMLFloatRecord(name,
                                                                                                                 unit,
                                                                                                                 value),
                                                                                                callback(callback) {};
